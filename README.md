...
- [📖 Hello React Frontend ](#-hello-react-front-end-)
...
**Hello React Frontend** is a frontend web application that displays a random greeting message on screen, using [Hello Rails Backend](https://github.com/gealsanchez/hello-rails-back-end.git) API.
...
- [API](https://github.com/gealsanchez/hello-rails-back-end.git)
...
```
  git clone git@github.com:gealsanchez/hello-react-front-end.git
```
